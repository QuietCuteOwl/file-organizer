...
def organizer(input_dir, output_dir):
    ...
    for key in DEFAULT_type2ext:
        value = DEFAULT_type2ext[key]
        for ext in value:
            ext2type[ext] = key
    ...
    for filename in os.listdir(input_dir):
        ...
        if os.path.isdir(os.path.join(output_dir, filename)) or filename == CURRENT_SCRIPT:
            continue
